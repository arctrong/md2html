...
class BackReferencesPluginContentExtendedE2eTest(unittest.TestCase):
    ...
    def test_refs_before_definition(self):
        ...
        def_com_page = self.html.read('extended_def_com.html')
        def_com_anchor = def_com_page.body.p.a['name']

        ref_page = self.html.read('extended_ref_first.html')
    ...
    def test_multi_referencer_back_links(self):
        def_page = self.html.read('extended_def_com.html')
        ...
        ref_first_page = self.html.read('extended_ref_first.html')
        ref_first_anchor = ref_first_page.body.p.sup.a['name']
        ref_second_page = self.html.read('extended_ref_second.html')
    ...
    def test_definition_page_references_other_source(self):
        def_net_page = self.html.read('extended_def_net.html')
        ...
        ref_net_page = self.html.read('extended_ref_net.html')
    ...
    def test_relative_paths(self):
        def_page = self.html.read('defs/extended_subdir_def.html')
        def_paragraph = def_page.body.p
        def_anchor = def_paragraph.a['name']
        self.assertEqual('[subdir_example]', def_paragraph.span.text)

        ref_page = self.html.read('pages/extended_subdir_ref.html')
