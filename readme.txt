...
self-contained static HTML sites that needs only a browser to be viewed.

Finally, **M<sub>2</sub>H** includes plugins that automate common tasks and help the result
look professional.
