...
class MetadataFinderTest {
    ...
    @Test
    public void metadata_finder_trivial() {
    ...
    @Test
    public void metadata_finder_marginPositions() {
    ...
    @Test
    public void metadata_finder_must_ignore_first_closing_delimiter() {
    ...
    @Test
    public void metadata_finder_nested_metadata_must_preserve() {
